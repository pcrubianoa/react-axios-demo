...
class Talks extends React.Component {
    ...
    render() {
        ...
        return <div className="container">
            <div className="content"><h1>Talks</h1></div>
            <div className="columns is-multiline">
                {
                    talks.map(talk => {
                        return <div className="column is-one-quarter-desktop is-one-third-tablet" key={talk.id}>
                            <div className="b-talk" >
                                <div className="b-talk__image">
                                    <img src={"http://conference.webtraining.fun/" + talk.thumbnail} alt="" />
                                </div>
